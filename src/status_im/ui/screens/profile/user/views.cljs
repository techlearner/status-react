  ...
  (let [messages @(re-frame/subscribe [:chats/current-chat-messages-stream])
    ...
    (if no-messages?
      [react/view {:padding-horizontal 32 :margin-top 32}
       [react/view {:border-width              1 :border-color colors/gray-lighter :border-top-right-radius 16
                    :border-bottom-left-radius 16 :border-top-left-radius 16 :border-bottom-right-radius 4
                    :padding-horizontal        12 :padding-vertical 6}
        [react/text {:style {:color colors/gray :line-height 22}}
         "Status updates are messages you publish to your profile. They can be viewed by anyone visiting your profile inside Status"]]
