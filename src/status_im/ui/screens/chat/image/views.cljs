...
;; FIXME(Ferossgp): Add images scope permission when implemented:
;; https://github.com/zoontek/react-native-permissions/pull/522
...
(defview image-view []
  {:component-did-mount get-camera-roll}
